...
window.addEventListener('load', function(){
	...
	console.log=function(){};
		...
		var ramme5 = spawnObject("models/pillar.mtl","models/pillar.obj");
		ramme5.scale.set(2,2,2);
		ramme5.position.set(-600,0,300);
		ramme4.add(ramme5);

		var ramme6 = spawnObject("models/pillar.mtl","models/pillar.obj");
		ramme6.scale.set(2,2,2);
		ramme6.position.set(-600,0,-300);
		ramme4.add(ramme6);
		//********* GUI controls *******
		/*
